...
P(('sapo','Bài viết đưa bảng phân bổ diện tích từng khu, bảng nên bố trí những gì và nên bỏ bớt những gì, ba sơ đồ mặt bằng vẽ theo ba hình dạng thực tế, các mẫu thiết kế theo phong cách và chi phí tham khảo theo giá thị trường — để doanh nghiệp có căn cứ chốt phương án ngay từ đầu.'))
...
P(('h3','1.1. Ba mức bố trí văn phòng 70m2 và số chỗ ngồi tương ứng'))
...
P(('h3','1.2. Vì sao mỗi nơi nói một con số nhân sự khác nhau cho văn phòng 70m2?'))
...
P(('h3','1.3. Bố trí văn phòng 70m2: cách chia quyết định số chỗ ngồi'))
...
# ---------------- MUC 2 ----------------
P(('h2','2. Bố trí văn phòng 70m2: giữ thêm một phòng riêng là mất mấy chỗ ngồi?'))
...
P(('h3','2.1. Ba cách bố trí văn phòng 70m2 theo loại hình doanh nghiệp'))
...
P(('table',
   ['Cách bố trí','Nên bố trí gì — nên bỏ gì','Số chỗ ngồi','Hợp với'],
