...
P(('h2','5. Luồng khách và luồng nhân viên — thứ quyết định văn phòng 90m2 có chạy trơn không'))
...
P(('h3','5.2. Ba lỗi luồng hay gặp nhất ở văn phòng 90m2'))
P(('table',
...
P(('h3','5.3. Tách tiếng ồn trong văn phòng 90m2 mà không xây thêm tường'))
...
P(('ul',[
  ...
  '**Tấm tiêu âm treo trần phía trên khu làm việc** — khoảng 300.000 – 600.000đ/m² trần, xử lý được phần tiếng vọng, không đụng tới mặt bằng.',
...
P(('p','Tối giản không phải là làm ít đồ cho rẻ, mà là bỏ hết những gì không có công năng: không phào chỉ, không trần giật cấp nhiều lớp, không tủ trang trí. Đồ lưu trữ giấu vào tường hoặc gom vào một hệ tủ duy nhất. Bảng màu thường chỉ hai đến ba màu — trắng, be, gỗ sáng — cộng đúng một màu nhấn.'))
P(('lead','Ưu điểm với mặt bằng 90m²'))
P(('ul',[
...
P(('p','Phần trang trí thuần túy — phào chỉ, trần giật cấp, tủ trưng bày — thường chiếm 10 – 15% tổng chi phí thi công. Với văn phòng 90m² làm gói tiêu chuẩn (360 – 630 triệu), bỏ hẳn nhóm này tiết kiệm khoảng **36 – 95 triệu**, đủ để nâng cấp toàn bộ ghế làm việc và bù cho một phòng họp vách kính cách âm. Về diện tích, thay bốn tủ đứng cao 2m bằng hệ tủ âm tường trả lại khoảng 3 – 4m² sàn, tức thêm được một đến hai chỗ ngồi.'))
