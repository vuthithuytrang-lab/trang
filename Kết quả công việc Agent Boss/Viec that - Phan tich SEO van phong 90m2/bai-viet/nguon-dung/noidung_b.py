...
# ---------------- MUC 2 ----------------
P(('h2','2. Thiết kế văn phòng 90m2 khác gì 70m2 và 80m2?'))
...
P(('p','Đó cũng là lý do toàn bộ phần còn lại của bài này nói về ba thứ: phân khu, luồng di chuyển và cách làm hiện đại. Không mục nào nói về cách cắt bớt, vì ở 90m² doanh nghiệp không còn phải cắt.'))

# ---------------- MUC 3 ----------------
P(('h2','3. Bố trí văn phòng 90m2 hiện đại: chia 5 khu và bảng phân bổ diện tích'))
...
P(('table',
   ...
   [['Lễ tân và khu chờ','8 – 12%','7 – 11 m²','2 – 4 chỗ chờ','Điểm dừng đầu tiên, chặn khách lại trước khi vào trong'],
    ...
    ['Pantry','4 – 7%','4 – 6 m²','4 chỗ','Đặt xa khu làm việc và xa lễ tân vì mùi và tiếng ồn'],
...
P(('h3','3.1. Chia khu kiểu cũ và chia khu trong thiết kế văn phòng 90m2 hiện đại'))
P(('p','Cùng năm khu như nhau, nhưng cách chia của mười năm trước và cách chia hiện nay cho ra hai kết quả rất khác về số chỗ ngồi. Bảng dưới đây là năm điểm đổi thay rõ nhất:'))
P(('table',
   ['Hạng mục','Cách chia kiểu cũ','Cách chia hiện đại','Được gì'],
   [['Ranh giới giữa các khu','Vách thạch cao đặc, cao kịch trần','Vách kính khung nhôm hoặc khung thép','Trả lại 4 – 5m² sàn, tức 2 chỗ ngồi'],
    ['Phòng ban','Mỗi bộ phận một phòng riêng','Một sàn mở, chỉ giữ phòng họp và phòng giám đốc','Bớt 9 – 12m² tường và hành lang dẫn vào'],
    ['Lối đi','Hành lang xương cá, nhiều nhánh cụt','Một trục thẳng phục vụ cả mặt bằng','Lối đi giảm từ 18 – 20% xuống 12 – 15%'],
    ['Lưu trữ','Tủ hồ sơ đứng cao 2m kê giữa sàn','Tủ âm tường cộng lưu trữ số','Trả lại 3 – 4m² sàn'],
    ['Chỗ ngồi','Bàn cố định, kích thước lớn','Bàn mô-đun 1,2 × 0,6m ghép nối được','Thêm 4 – 5 chỗ và đổi bố cục không cần đập vách']]))
P(('p','Cộng cả năm dòng lại, cách chia hiện đại cho thêm khoảng **4 – 6 chỗ ngồi** trên cùng một mặt bằng 90m², mà không phải bỏ khu chức năng nào. Đó là lý do bài này lấy cách làm hiện đại làm mặc định cho mọi phương án phía dưới.'))
P(('img','b80-24','Nội thất thay vách ngăn để chia khu mà không dựng thêm tường, cách chia khu hiện đại giúp giữ tỷ lệ khu làm việc chung trên 45% (Ảnh tham khảo)'))

# ---------------- MUC 4 — SO DO ----------------
P(('h2','4. Ba sơ đồ mặt bằng trong thiết kế văn phòng 90m2 và hai luồng di chuyển'))
...
P(('p','**Vấn đề luồng:** đây là sơ đồ sạch nhất về đường đi. Khách vào là ở luôn trong dải tiếp khách phía trên, muốn họp thì rẽ xuống lối đi 1,4m mà **không một lần nào bước vào khu làm việc**. Đổi lại, phòng họp chỉ còn 8,1m² nên tối đa 6 chỗ, và pantry bị đẩy xuống cuối lối đi.'))
