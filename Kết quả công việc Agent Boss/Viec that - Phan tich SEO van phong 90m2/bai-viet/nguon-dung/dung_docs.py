...
RAW=('https://raw.githubusercontent.com/vuthithuytrang-lab/trang/claude/serene-noether-tnjmy3/'
     ...
     'Viec%20that%20-%20Phan%20tich%20SEO%20van%20phong%2070m2/bai-viet/so-do-mat-bang/{}.png')
...
doc=('<html><head><meta charset="utf-8"><title>Thiết kế văn phòng 90m2: chia 5 khu, đủ 15–18 chỗ ngồi</title></head>'
     '<body>'+'\n'.join(o)+'</body></html>')
p='/tmp/claude-0/-home-user-trang/b01499db-3e47-587b-84ec-f73e3ff320ac/scratchpad/bai90/cho-google-docs.html'
