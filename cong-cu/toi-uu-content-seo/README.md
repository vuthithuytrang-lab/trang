# Bộ công cụ tối ưu content SEO

Các file trong thư mục này đi cùng nhau. Khi Trang nhờ **phân tích search intent** hoặc
**tối ưu một bài viết**, đọc lại trước khi làm, đừng làm theo trí nhớ.

| File | Dùng khi nào |
|---|---|
| **`QUY-TRINH-NGHIEN-CUU.md`** | **File chạy việc — bản tổng hợp 7 chặng. Mở đầu tiên.** |
| `quy-trinh-nghien-cuu.html` | Bản xem được cho Trang (mở bằng trình duyệt, đọc được trên điện thoại) |
| `khung-phan-tich-doi-thu.md` | Bảng chấm chi tiết cho chặng 2–5 |
